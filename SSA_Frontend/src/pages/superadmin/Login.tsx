...
export const SuperadminLogin: React.FC = () => {
  ...
  const handleEmailChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setEmail(val)
    if (emailTouched) setEmailError(validateUsername(val))
    setError(null)
  }
  ...
  const handleEmailBlur = () => {
    ...
    setEmailError(validateUsername(email))
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setEmailTouched(true)
    setPasswordTouched(true)
    const eErr = validateUsername(email)
    ...
    try {
      ...
      if (success) {
        const savedUserStr = localStorage.getItem('ssa_auth_user')
        if (savedUserStr) {
        ...
        // If not a Super Admin, log out and show error
        logout()
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-3">
              ...
              <div className="leading-none text-left">
                <div className="font-bold text-lg text-text-base tracking-widest uppercase">
                  SSA <span className="text-brand-primary">ERP</span>
                </div>
                <div className="text-[9px] font-semibold text-text-muted tracking-[0.2em] uppercase mt-0.5">SUPERADMIN PANEL</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h1 className="text-4xl xl:text-5xl font-extrabold text-text-base leading-tight tracking-tight">
                Streamline.<br />
                Manage. Build.<br />
                All in <span className="text-brand-gold">One</span> Place.
              </h1>
              <p className="text-base text-text-muted leading-relaxed max-w-sm">
                SSA ERP helps you manage projects, teams, clients, and resources efficiently.
              </p>
            </div>
        ...
        <div className="w-full max-w-lg bg-bg-panel rounded-2xl border border-brand-primary/50 dark:border-slate-700/80 shadow-[0_8px_32px_0_rgba(0,0,0,0.2)] p-10">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="leading-none text-left">
              ...
              <div className="text-[9px] font-bold text-text-muted tracking-[0.3em] uppercase mt-0.5">
                SUPERADMIN PANEL
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 text-left">
            <span className="text-gray-500 font-semibold tracking-wide text-xs">Welcome Back,</span>
            <h2 className="text-3xl font-extrabold text-gray-900 mt-1 tracking-tight">Super Admin</h2>
            <div className="h-[2px] w-12 bg-brand-primary mt-2 mb-3" />
            <p className="text-sm text-gray-500">Please login to access the SSA ERP Superadmin Panel.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5 text-left">
              ...
              <div className="relative flex items-center">
                <span className={`absolute left-3 transition-colors duration-200 ${emailError && emailTouched ? 'text-red-500' : 'text-gray-400'}`}>
                ...
                <input
                  ...
                  maxLength={20}
                  className={`w-full pl-10 pr-4 py-2.5 rounded-lg border text-sm text-gray-900 placeholder-gray-400 bg-white focus:outline-none focus:ring-2 transition-all duration-200 ${emailError && emailTouched
